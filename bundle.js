...
.dog-icon {
  width: 50px;
}`, "",{"version":3,"sources":["webpack://./src/css/index.scss","webpack://./src/css/_variables.scss"],"names":[],"mappings":"AAEA;EACE,gEAAA;EACA,aAAA;EACA,WAAA;AADF;;AAIA;EAEE,yBCTuB;ADOzB;;AAKA;EACE,WAAA;AAFF","sourcesContent":["@import 'variables';\n\nbody {\n  background: url('../../dist/images/park.jpg') center/cover;\n  height: 100vh;\n  width: 100%;\n}\n\nnav {\n  // Example of using a variable:\n  background-color: $secondary-accent-color;\n}\n\n.dog-icon {\n  width: 50px;\n}","$main-accent-color: #3F8DA8;\n$secondary-accent-color: #92E0E5;"],"sourceRoot":""}]);
// Exports
